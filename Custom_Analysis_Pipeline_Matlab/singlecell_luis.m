...
folder_files='./jonas/';
day_comp=[0,10,14,42]; % 0, 10, 14, or 42
day_comp_index=3;
...
list_genes_hist={'SOX2'};

pvals=PermutationTest(Both_expr_max_log',labels,5000);

for i_g=1:length(list_genes_hist)
...
A_expr_max_table=array2table(A_expr_max,'RowNames',list_of_genes);
writetable(A_expr_max_table,['A_' num2str(day_comp) '_filt.txt'],'WriteRowNames',1)
writetable(A_expr_max_table,['A_' num2str(day_comp) '_filt.csv'],'WriteRowNames',1)


B_expr_max_table=array2table(B_expr_max,'RowNames',list_of_genes);
writetable(B_expr_max_table,['B_' num2str(day_comp) '_filt.txt'],'WriteRowNames',1)
writetable(B_expr_max_table,['B_' num2str(day_comp) '_filt.csv'],'WriteRowNames',1)
